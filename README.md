...
- **An icon language, not decoration** — every stat has its own instrument glyph, clearance gates carry a rising three-step staircase (never a padlock), log and mail lines carry their subject's mark, and every price carries the crown mark. 97 original SVGs, one stencil grammar.
